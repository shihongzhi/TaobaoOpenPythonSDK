...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 传入类目ID,必需是叶子类目，通过taobao.itemcats.get获取类目ID pvs和datetime二者必需传一个 返回字段目前支持有：cid,pid,prop_name,vid,name,name_alias,status,sort_order 作用:获取标准类目属性值</SPAN>
# <UL>
# <LI>
