...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新分销平台产品数据，不传更新数据返回失败</SPAN>
# <UL>
# <LI>
...
class FenxiaoProductUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Sample</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">12313454121</SPAN>
        # </LI>
        # </UL>
        self.pid = None
