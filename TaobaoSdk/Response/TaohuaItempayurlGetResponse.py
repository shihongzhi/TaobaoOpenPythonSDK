...
class TaohuaItempayurlGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Sample</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">http://www.taohua.com/xxx/xxxx.do?item_id=123&uid=942&sign=Xdsfsdf324234XXSf3434CVd&sign_type=RSA&timestamp=1293766895688</SPAN>
        # </LI>
        # </UL>
        self.url = None
