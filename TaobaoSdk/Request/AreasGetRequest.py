...
## @brief 查询标准地址区域代码信息 参考：http://www.stats.gov.cn/tjbz/xzqhdm/t20080215_402462675.htm
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询标准地址区域代码信息 参考：http://www.stats.gov.cn/tjbz/xzqhdm/t20080215_402462675.htm</SPAN>
# <UL>
# <LI>
...
class AreasGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Sample</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">id,type,name</SPAN>
        # </LI>
        # </UL>
        self.fields = None
